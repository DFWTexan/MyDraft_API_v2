...
namespace MyDraftAPI_v2.FantasyDataModel
{
    public class FantasyLeage
    {
        ...
        public class FantasyLeague
        {
            ...
            public static async Task<IList<DraftPick>> getAuctionSelections(FantasyLeague league)
            {
                IList<DraftPick> auctionSelections = await DraftManager.auctionPicksForLeague(league);
