...
namespace MyDraftAPI_v2.Managers
{
    public class LeagueManager
    {
        ...
        public static async Task<FantasyLeague> createLeague()
        {
            ...
            await createTeams(leagueID, LEAGUE_TEMP_NUM_TEAMS);
        ...
        public static async Task<FantasyTeam> createTeamForLeague(FantasyLeague league)
        {
        ...
        public static async Task updateTeamsForLeague(FantasyLeague league)
        {
            if (!league.draftByTeamEnabled)
            {
                return;
        ...
        public static async Task<IDictionary<int, double>> getLeagueRankings()
        {
        ...
        public static async Task<List<RosterConfigItem>> getRosterConfig(string leagueID)
        {
            ...
            starterValues.Add(new MyDraftAPI_v2.Managers.LeagueManager.RosterConfigItem { positionKey = "Bench", value = 0, sortValue = 99 });
